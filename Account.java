...
public class Account {
	...
	public double deposit(double amount) {
		...
		System.out.println("Hello, the DEPOSIT is sucessful and your current balance is" + " "
						+ accountBalance
						+ " "
						+ ". Last date of Transaction is"
						+ " "
						+ dateOfTransaction);
		return amount;
	}
	...
	public void withdraw(double withdrawAmount) {
		if (accountStatus == "Active" && withdrawAmount <= accountBalance) {
			accountBalance = accountBalance - withdrawAmount; // if the account
									...
									// withdraw the
									// money
			System.out.println("Your WITHDRAWAL is sucessful and the current balance is" + " " + accountBalance);
		} 
			...
			System.out.println("Your account is not active and you don't have sufficient amount");
		this.dateOfTransaction = new Date();
		System.out.println("The last date of trasaction is:" + " " + dateOfTransaction);
